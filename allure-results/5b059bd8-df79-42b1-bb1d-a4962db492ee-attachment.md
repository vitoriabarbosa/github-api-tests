...
- Name: tests/unit/schemaValidation.spec.js >> Schema Validation Tests >> SCHEMA-003 - Validar múltiplos itens em array
- Location: tests/unit/schemaValidation.spec.js:35:5
